...
public struct WINDIVERT_IPHDR
{
    ...
    public IPAddress SrcAddr
    {
        ...
        set
        {
            ...
            {
              throw new ArgumentException("Not a valid IPV4 address. (SrcAddr)");
            }
    ...
    public IPAddress DstAddr
    {
        ...
        set
        {
            ...
            if(value.AddressFamily != System.Net.Sockets.AddressFamily.InterNetwork)
            {
              throw new ArgumentException("Not a valid IPV4 address. (DstAddr)");
            }
    ...
    public IPAddress SrcAddr
    {
        ...
        set
        {
            fixed (uint* addr = this.SourceAddress)
            {
                ...
                {
                  throw new ArgumentException("Not a valid IPV6 address. (SrcAddr)");
                }
    ...
    public IPAddress DstAddr
    {
        ...
        set
        {
            fixed (uint* addr = this.DestinationAddress)
            {
                ...
                if(valueBytes.Length != 16)
                {
                  throw new ArgumentException("Not a valid IPV6 address. (DstAddr)");
                }
...
{
    //[DllImport("WinDivert.dll", EntryPoint = "GetLastError")]
    //public static extern string WinDivertGetLastError();
